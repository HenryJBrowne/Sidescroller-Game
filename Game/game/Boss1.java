...
public class Boss1 extends Enemy {
     ...
     */
    public Boss1(Vector2f pos, Texture[][] idle, Texture[][] attack, Texture[][] run) {
        super(5.5f, 4f, 500, 50, pos, new Vector2f(16, 48), idle, run, attack, true);
    }
    ...
    public void behave(MainCharacter eugene, Screen s) {
        // TLDR : if within 100 blocks, the boss will chase and melee the player,
        // if between 100 and 400, the boss will move away from the player and use
        // ranged
        // attacks.
        ...
        if (dist < 100) {
            ...
            if (RangedCd >= 30) {
                ...
                s.getWorld().addProjectile(new FireBall(new Vector2f(getPosition().x + OFFSET, getPosition().y + 24),
    ...
    public void die(Screen screen) {
        ...
        if (screen.getLevel().getNumber() == 4) {
