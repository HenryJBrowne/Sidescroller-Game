...
public class Boss4 extends Enemy {
     ...
     */
    public Boss4(Vector2f pos, Texture[][] idle, Texture[][] attack, Texture[][] run) {
        super(10f, 4f, 1000, 50, pos, new Vector2f(32, 54), idle, run, attack, true);
    }
        ...
        if (dist < 300) {
            if (dist < 100) {
                ...
                if (RangedCd >= 30) {
                    ...
                    s.getWorld().addProjectile(new ThrowingDagger(
