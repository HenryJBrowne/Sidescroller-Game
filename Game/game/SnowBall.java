...
public class SnowBall extends Enemy {
    ...
    public SnowBall(Vector2f pos, Texture[][] idle, Texture[][] run, Texture[][] attack) {
        super(12f, 0f, hp, attackI, pos, new Vector2f(32, 32), idle, run, attack,true);
    }
